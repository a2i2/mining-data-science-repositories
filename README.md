...
**Figshare:** Extract contents of [results.tar.gz](https://doi.org/10.6084/m9.figshare.12377237) to `output` directory, then jump to _Analyse results (in Jupyter)_ section.
